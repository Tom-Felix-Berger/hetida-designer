"""Documentation for Simple Volatility Score
...
def volatility(series, freq, stamped="right"):
    ...
    if stamped == "left":
        ...
        return vols.shift(freq=freq, periods=-0.5)  # only works if freq is "divisible by 2"
    else:
        raise ValueError("Only 'left' or 'right' or 'center' allowed for stamping parameter.")
...
COMPONENT_INFO = {
    "inputs": {
        ...
        "window_timestamp_location": {"data_type": "STRING"},
    },
    "outputs": {
        "volatilities": {"data_type": "SERIES"},
    },
...
def main(*, timeseries, window_size, window_timestamp_location):
    ...
    return {"volatilities": volatility(timeseries, window_size, window_timestamp_location)}
...
TEST_WIRING_FROM_PY_FILE_IMPORT = {
    "input_wirings": [
        ...
        {"workflow_input_name": "window_size", "filters": {"value": "4h"}},
        {
